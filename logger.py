...
def log_data(profile: dict, scenario: str, data: dict, result: dict):
    row = {
        ...
        "stability_index": result.get("stability_index", 100),
        "patient_state": result.get("patient_state", "Stable"),
        "fuzzy_risk_score": result.get("fuzzy_risk_score", result.get("score", 0)),
        "confidence_score": result.get("confidence_score", 50),
        "fuzzy_breakdown": result.get("fuzzy_breakdown", ""),
